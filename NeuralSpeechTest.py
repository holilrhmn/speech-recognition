...
audio = AudioSegment.from_file(ses_yol + "textbook" + "/textbook2.wav"  , format="wav", frame_rate=44100)
...
data = scalers["textbook"].transform(data)
...
def test_all_files  ( path , hmm_list ):
    ...
    for file in file_list:
        ...
        audio = AudioSegment.from_file(path + "/" + file, format="wav", frame_rate=44100)
        audio = audio.set_frame_rate(16000)
        audio.export("filtered-talk1.wav", format="wav")
